...
[Try here](https://portfolio-eight-pi-88.vercel.app/experiments/3d-camera-test). A project for my Math IA written from scratch in JavaScript. Render shapes in 3D based on camera translation and rotations. Control camera position with arrow keys, space (up) and shift (down).
